...
<Tabs items={['NextJS', 'React']}>
  ...
  <Tab value="React">
    ...
    <Callout title="Note">
    For Vite project, add this script tag to your `index.html` file in the project root directory. This is necessary for Google OAuth to work properly with RainbowKit. If using Onboarding Modal, this script is not required.
    ```html
