...
Chains & Tokens enable you to manage which chains and tokens will be enabled for your users. This feature gives you precise control over the blockchain ecosystems and assets your users can interact with through your application.
...
<Callout title="Important" type="warn">
  Once a chain is enabled, it **cannot be disabled**. Please carefully consider your selection as this action is irreversible.
</Callout>
...
![Wallet Controls - Okto Dashboard](/images/dashboard-img-v2/dashboard-chains-n-wallets-v2.png)

3. Click the **Enable Chain** button.  

4. In the pop-up window, you'll see a list of available chains, including mainnet and testnet options.  

<div className="">
    <img 
        src="/images/dashboard-img-v2/dashboard-chainsnwallets-enablec-v2.jpg" 
        alt="Wallet Controls - Okto Dashboard" 
        className="w-full rounded-lg shadow-sm"
    />
</div>

5. Select the chain(s) you want to enable for your users. 

6. Click **Enable Chain(s)** to confirm your selection.

### Important Considerations

* Choose chains that are relevant to your application's functionality and your users' needs.  
* Users who have accessed Okto through other clients may have wallets on chains you haven't selected. These wallets will not be visible within your application, but users can still access them through other Okto-integrated apps that have enabled those chains.
...
<Callout title="Important" type="warn">
  Once tokens are enabled, they **cannot be disabled**. Please carefully consider your selection as this action is irreversible.
</Callout>
...
<div className="">
    <img 
        src="/images/dashboard-img-v2/dashboard-chainsnwallets-enablet-v2.png" 
        alt="Wallet Controls - Okto Dashboard" 
        className="w-full rounded-lg shadow-sm"
    />
</div>
