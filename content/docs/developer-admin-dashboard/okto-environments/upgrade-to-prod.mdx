...
description: When your application is fully integrated and tested in the Sandbox environment, you can upgrade to a production account to go live with your Okto integration on Okto Mainnet.
full: false
---
...
2. **Submit Upgrade Request**:  
   ...
   * Fill out the [Upgrade Request Form](https://form.typeform.com/to/jskNWEIE).  
