...
The App Secret is a confidential key used to authenticate your API requests. This is the private key (EVM ECDSA) of the authority of the client SWA on the Okto Chain. Keep this secret secure and never share it publicly or include it in client-side code. In case the key is compromised, you can always reset the authority.
