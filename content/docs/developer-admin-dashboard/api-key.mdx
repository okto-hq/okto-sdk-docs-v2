...
The App ID is a unique identifier for your application and you as a [Client](/docs/introduction-to-okto/okto-client-user). It's used to associate your Okto client with this specific app in our system.
