...
- **Gas Sponsorship (Optional):** Enable users to interact with protocols even without holding chain-native tokens. Learn more in the [Sponsorship documentation](/docs/developer-admin-dashboard/sponsorship/overview).
