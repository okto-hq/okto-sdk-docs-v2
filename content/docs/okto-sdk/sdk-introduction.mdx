...
Check out our detailed guides on [Google OAuth](../react-sdk/authenticate-users/google-oauth/google-console-setup), [Email OTP](../react-sdk/authenticate-users/email-otp/learn), or [Phone OTP](../react-sdk/authenticate-users/phone-otp/learn) implementations to set up these flows.
</Callout>
