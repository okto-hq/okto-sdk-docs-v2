...
import { LuLayoutDashboard, LuToggleLeft, LuCode, LuWallet, LuBookOpen } from "react-icons/lu";
import { IoDocumentOutline } from "react-icons/io5";


## Start building with Okto SDK
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 lg:gap-8">
  ...
  <TechnologyCard
      ...
      link="https://docs.okto.tech/docs/developer-admin-dashboard/sponsorship/overview"
  />
