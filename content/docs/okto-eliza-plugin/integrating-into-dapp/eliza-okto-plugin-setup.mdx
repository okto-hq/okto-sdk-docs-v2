...
Detailed explainations is give in [prerequisites](/docs/react-sdk/quickstart/prerequisites)
...
```
<ViewOnGithub url="https://github.com/okto-hq/okto-eliza-ai-agent-example/blob/main/.env.example" />
...
```
<ViewOnGithub url="https://github.com/okto-hq/okto-eliza-ai-agent-example/blob/main/src/index.ts" />
</Step>
