...
<Tabs items={['Typescript']}>
  <Tab value="Typescript">
    ```typescript
    import { getPortfolioActivity } from "@okto_web3/core-js-sdk/explorer"; // [!code highlight]

    const portfolioActivity = await getPortfolioActivity(oktoClient); // [!code highlight]
    ```
  </Tab>
</Tabs>
</Accordion>
