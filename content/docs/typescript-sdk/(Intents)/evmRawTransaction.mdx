...
description: Learn how to create raw EVM transactions using the Okto TypeScript SDK.
full: false
---
...
```typescript
import { evmRawTransaction } from "@okto_web3/core-js-sdk"; // [!code highlight]
...
```typescript
import { evmRawTransaction } from "@okto_web3/core-js-sdk/userop"; // [!code highlight]
...
| Field Name | Type | Description |
|------------|------|-------------|
| `result` | [`Promise<UserOp>`](/docs/typescript-sdk/technical-reference#models) | Returns the user operation for the raw transaction |
