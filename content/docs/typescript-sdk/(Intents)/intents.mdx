...
[Learn more →](/docs/typescript-sdk/(Intents)/tokenTransfer)

### 2. NFT Transfer Intent:

Transfer NFTs with ease and security.

[Learn more →](/docs/typescript-sdk/(Intents)/nftTransfer)

### 3. Raw Transaction Intent:

For advanced users: direct contract calls and complex operations.

[Learn more →](/docs/typescript-sdk/(Intents)/evmRawTransaction)