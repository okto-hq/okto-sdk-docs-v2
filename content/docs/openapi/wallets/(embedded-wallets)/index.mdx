...
description: Learn how to create embedded wallets for users within your application using the Okto API.
full: false
---
...
To retrieve a user's wallets across different chains, use the [`Get Wallet` API](/docs/openapi/explorer/get-wallets)
