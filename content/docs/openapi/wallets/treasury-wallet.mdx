...
The [`treasuryWallet_template.ts`](https://github.com/okto-hq/okto-sdkv2-ts-template/blob/main/src/auth/treasuryWallet_template.ts) script demonstrates how to generate this Okto Auth Token:
