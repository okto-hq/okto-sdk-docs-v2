...
description: Learn about Intents on Okto
full: false
---
...
[Learn more →](/docs/openapi/tokenTransfer)

### 2. NFT Transfer Intent:

Transfer NFTs with ease and security.

[Learn more →](/docs/openapi/nftTransfer)

### 3. Swap Intent:

Exchange tokens seamlessly across chains using Okto's Trade Service.

[Learn more →](#)

### 4. Raw Transaction Intent:

For advanced users: direct contract calls and complex operations.

[Learn more →](/docs/openapi/evmRawTransaction)