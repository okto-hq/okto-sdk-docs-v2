...
<KeyBenefitsGrid>
  <KeyBenefitCard
    icon={<IoPersonOutline size="1.8rem" className="text-blue-600" />}
    title="User-Friendly"
    points={[
  ...
  />
  <KeyBenefitCard
    icon={<IoFlashOutline size="1.8rem" className="text-yellow-500" />}
    title="Smart & Fast"
    points={[
  ...
  />
  <KeyBenefitCard
    icon={<IoShieldCheckmarkOutline size="1.8rem" className="text-green-600" />}
