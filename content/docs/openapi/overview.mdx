...
<Callout type="info">
  The OpenAPI specification documentation supports interactive elements for all REST APIs. For detailed code examples and helper scripts, check out the [Template Repository](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template).
</Callout>
