...
description: Authenticate users using Okto Auth by sending a JSON-RPC request to the Okto Gateway with the authToken received from Verify Whatsapp OTP as payload.
full: false
---
...
```json
{
  ...
  "result": {
    ...
    "clientSWA": "string",      // Vendor's wallet address
