...
|----------|-----------------|------------------|---------------------|
| <ExternalLink href="/docs/openapi/authenticate/google-oauth/loginUsingOktoAuth">Google Authentication</ExternalLink> | Handles user authentication via Google OAuth. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/googleAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/explorer/email-send-otp">Send Email OTP</ExternalLink> | Send OTP to user's email. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate/email` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/emailAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/explorer/email-verify-otp">Verify Email OTP</ExternalLink> | Verify OTP sent to email. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate/email/verify` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/emailAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/authenticate/auth-email/authenticate">Email Authentication</ExternalLink> | Handle user authentication via email OTP verification. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/emailAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/explorer/whatsapp-send-otp">Send WhatsApp OTP</ExternalLink> | Send OTP to user's WhatsApp. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate/whatsapp` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/whatsappAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/explorer/whatsapp-resend-otp">Resend WhatsApp OTP</ExternalLink> | Resend OTP to user's WhatsApp. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate/whatsapp/` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/whatsappAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/explorer/verify-whatsapp-otp">Verify WhatsApp OTP</ExternalLink> | Verify OTP sent to WhatsApp. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate/whatsapp/verify` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/whatsappAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/authenticate/auth-whatsapp/authenticate">WhatsApp Authentication</ExternalLink> | Handle user authentication via WhatsApp OTP verification. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/whatsappAuthenticate_template.ts) |
| <ExternalLink href="/docs/openapi/authenticate/auth-jwt/authenticate">JWT Authentication</ExternalLink> | Handle user authentication via existing JWT infrastructure. | `POST https://sandbox-api.okto.tech/api/oc/v1/authenticate` | [View Template](https://github.com/okto-hq/okto-sdkv2-ts-template/tree/main/src/api-template/auth/jwtAuthenticate_template.ts) |
