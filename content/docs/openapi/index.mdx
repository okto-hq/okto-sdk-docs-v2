...
<div className="my-6 grid grid-cols-1 md:grid-cols-2 gap-4">
  <TechnologyCard
    ...
    link="https://github.com/okto-hq/okto-sdkv2-ts-template/blob/main/src/api_template.ts"
  />
</div>
