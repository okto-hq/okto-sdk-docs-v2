...
- <ExternalLink href="/docs/openapi/troubleshooting">Troubleshooting Guide</ExternalLink>
- <ExternalLink href="/docs/openapi/technical-reference">Technical Reference</ExternalLink>
