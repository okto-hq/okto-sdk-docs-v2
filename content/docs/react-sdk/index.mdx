...
Detailed explanations can be found in the [prerequisites](/docs/nextjs-sdk/quickstart/prerequisites)
...
<Step>
    ...
    - **Google OAuth Credentials:** Create OAuth 2.0 credentials in the <ExternalLink href="/docs/react-sdk/authenticate-users/google-oauth/google-console-setup">Google Cloud Console</ExternalLink> to get your `VITE_GOOGLE_CLIENT_ID`.
