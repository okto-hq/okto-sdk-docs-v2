...
<Step>
    ...
    ReactDOM.createRoot(document.getElementById("root")!).render(
        <React.StrictMode>
            <OktoProvider config={config}>  // [!code highlight]
                <App />
...
<Step>
    ...
    ReactDOM.createRoot(document.getElementById("root")!).render(
        <React.StrictMode>
            <GoogleOAuthProvider clientId={import.meta.env.VITE_GOOGLE_CLIENT_ID}> // [!code highlight]
                <OktoProvider config={config}>
                    <App />
                </OktoProvider>
            </GoogleOAuthProvider> // [!code highlight]
        </React.StrictMode>
    );
    ```
    <ViewOnGithub url="https://github.com/okto-hq/okto-sdkv2-react-template-app/blob/main/src/main.tsx" />
