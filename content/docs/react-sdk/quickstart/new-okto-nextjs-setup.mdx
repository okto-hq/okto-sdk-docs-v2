...
- Retrieved your API keys from the dashboard (`NEXT_PUBLIC_VENDOR_PRIVATE_KEY` and `NEXT_PUBLIC_VENDOR_SWA`).
...
<Step>
    ...
    - **Okto API Keys:** You need your `NEXT_PUBLIC_VENDOR_PRIVATE_KEY` and `NEXT_PUBLIC_VENDOR_SWA`. Obtain these from the Okto Dashboard.
