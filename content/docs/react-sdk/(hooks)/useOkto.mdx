...
|--------|-----------|-------------|
| `loginUsingOAuth` | [`Promise<User>`](/docs/react-sdk/technical-reference#models) | Authenticate using OAuth providers |
...
| `signUserOp` | [`Promise<UserOp>`](/docs/react-sdk/technical-reference#models) | Sign a user operation |
