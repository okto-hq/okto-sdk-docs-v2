...
To learn more about delegated actions, check out the [Delegated Actions](/docs/react-sdk/wallets/delegated-actions) guide. To learn about policy based access control, check out the [Policy Engine](/docs/system-capabilities/policy-engine) page.
...
- [Login & Session Management](/docs/react-sdk/authenticate-users/login-logout/verifyLogin) - Handle user login and session states
