...
- **Integration Flexibility:** Okto SDK can be integrated alongside libraries like `ethers.js`, `web3.js`, `viem`, `wagmi`, or `@solana/web3.js` to interact with external wallets.
...
- Learn more about [Embedded Wallets](/docs/react-sdk/wallets)
- Explore [External Wallet](/docs/react-sdk/wallets/external-wallets) integration
- Check out the [Usage Guide](/docs/react-sdk/usage-overview) for common wallet operations
