...
description: Learn how to create raw EVM transactions using the Okto React Native SDK.
full: false
---
...
import { evmRawTransaction } from '@okto_web3/react-native-sdk'; // [!code highlight]
...
function RawTransaction() {
    ...
    return (
        <TouchableOpacity onPress={handleRawTransaction}>
...
```typescript
import { useOkto } from '@okto_web3/react-native-sdk';
import { evmRawTransaction } from '@okto_web3/react-native-sdk/userop'; // [!code highlight]
import { TouchableOpacity, Text } from 'react-native';
