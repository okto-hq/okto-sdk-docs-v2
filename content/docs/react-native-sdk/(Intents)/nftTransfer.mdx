...
| `data` | [`NFTTransferIntentParams`](/docs/react-native-sdk/technical-reference#models) | Parameters for the NFT transfer |
...
import { nftTransfer } from '@okto_web3/react-native-sdk';
...
function NFTTransfer() {
    ...
    return (
        <View>
            <Pressable onPress={handleNFTTransfer}>
