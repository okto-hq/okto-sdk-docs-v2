...
description: Learn how to create token transfer operations using the Okto React Native SDK.
full: false
---
...
import { tokenTransfer } from '@okto_web3/react-native-sdk'; // [!code highlight]
...
```typescript
import { useOkto } from '@okto_web3/react-native-sdk';
import { tokenTransfer } from '@okto_web3/react-native-sdk/userop'; // [!code highlight]
import { TouchableOpacity, Text, View } from 'react-native';
...
| Field Name | Type | Description |
|------------|------|-------------|
| `result` | [`Promise<UserOp>`](/docs/react-native-sdk/technical-reference#models) | Returns the user operation for the token transfer |
