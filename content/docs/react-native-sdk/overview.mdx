...
Kickstart your project by following our [Quickstart Guide](/docs/react-native-sdk). This guide will take you through installing the SDK, configuring your project, and executing your first transaction.
...
Ready to dive in? Begin with our **[Quickstart Guide](/docs/react-native-sdk)** to set up your environment, obtain your Okto API key, and build your first React Native application powered by the Okto SDK.
