...
<Callout>
Want an even faster setup? Check out our <ExternalLink href="https://github.com/okto-hq/okto-sdkv2-react-native-template-app">Template Repo</ExternalLink> to get your app running in minutes! It includes:
...
<Step>
    ...
    - **Google OAuth Credentials:** Create OAuth 2.0 credentials in the <ExternalLink href="https://console.cloud.google.com/">Google Cloud Console</ExternalLink>
     ...
     <CollapsibleCallout type="tip" title="Setting up Google OAuth">
        ...
        1. For Web & Expo Go: <ExternalLink href="/docs/react-native-sdk/authenticate-users/google-oauth/web-setup">Web Client Setup</ExternalLink>
        2. For iOS: <ExternalLink href="/docs/react-native-sdk/authenticate-users/google-oauth/ios-setup">iOS Setup</ExternalLink>
        3. For Android: <ExternalLink href="/docs/react-native-sdk/authenticate-users/google-oauth/android-setup">Android Setup</ExternalLink>
    </CollapsibleCallout>
</Step>
...
<Step>
    ...
    <Tabs items={['npm', 'pnpm', 'yarn']}>
        <Tab value="npm">
            ```bash
            npm i @okto_web3/react-native-sdk expo-auth-session expo-web-browser
            ```
        </Tab>
        <Tab value="pnpm">
            ```bash
            pnpm add @okto_web3/react-native-sdk expo-auth-session expo-web-browser
            ```
        </Tab>
        <Tab value="yarn">
            ```bash
            yarn add @okto_web3/react-native-sdk expo-auth-session expo-web-browser
            ```
        </Tab>
    </Tabs>
</Step>
