...
<Step>
    ...
    <Tabs items={['npm', 'yarn']}>
        <Tab value="npm">
            ```bash
            npm i @react-native-community/google-signin @react-native-async-storage/async-storage @okto_web3/react-native-sdk
            npx pod-install
            ```
        </Tab>
        <Tab value="yarn">
            ```bash
            yarn add @react-native-community/google-signin @react-native-async-storage/async-storage @okto_web3/react-native-sdk
            npx pod-install
            ```
        </Tab>
    </Tabs>
