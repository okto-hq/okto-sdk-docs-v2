...
For a detailed understanding of wallet providers, interoperability, and how they work within the Okto ecosystem, see our [Embedded Wallets](/docs/system-capabilities/embedded-wallets#the-wallet-provider-ecosystem#the-wallet-provider-ecosystem) guide.
</Callout>
