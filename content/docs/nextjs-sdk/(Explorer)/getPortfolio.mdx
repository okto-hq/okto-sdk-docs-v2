...
import { getPortfolio } from '@okto_web3/react-sdk'; // [!code highlight]
...
|------------|------|-------------|
| `portfolio` | [`Promise<UserPortfolioData>`](/docs/nextjs-sdk/technical-reference#models) | User's portfolio information |
