...
import { getPortfolioActivity } from '@okto_web3/react-sdk'; // [!code highlight]
...
|------------|------|-------------|
| `activities` | [`Promise<UserPortfolioActivity[]>`](/docs/nextjs-sdk/technical-reference#models) | Array of user's portfolio activities |
