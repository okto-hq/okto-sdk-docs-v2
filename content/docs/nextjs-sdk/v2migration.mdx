...
This guide provides a detailed walkthrough for migrating a NextJS application from [Okto SDK V1](https://docsv1.okto.tech/docs/react-sdk) to [Okto SDK V2](https://docsv2.okto.tech/docs/nextjs-sdk).  
