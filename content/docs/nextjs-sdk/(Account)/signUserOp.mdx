...
|-----------|------|-------------|-----------|
| `userop` | [`UserOp`](/docs/nextjs-sdk/technical-reference#models) | The user operation to be signed | Yes |
...
|------------|------|-------------|
| `result` | [`Promise<SignedUserOp>`](/docs/nextjs-sdk/technical-reference#models) | Returns the signed user operation |
