---
title: Learn 
description: Implement secure, passwordless login with Okto SDK using email-based OTPs. Learn session handling, token verification, and automated OTP delivery.
full: false
---
