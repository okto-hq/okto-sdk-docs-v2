...
description: Authenticate users via email using Okto's NextJS SDK with sendOTP, resendOTP, and loginUsingEmail methods for secure, token-based session management.
full: false
---
