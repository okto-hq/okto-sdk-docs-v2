---
title: Okto / Client / User
description: "In the Okto documentation, you'll frequently encounter three main personas: Okto, Client, and User. These personas are key to navigating how Okto interacts with developers and users across its platform. Let's break down each of these roles to understand their place in the ecosystem."
full: false
---
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      <PersonaCard
        ...
        title="Okto"
        description="Okto refers to our company, our platform, and the suite of services we provide, including Wallet and SDK."
      />
      <PersonaCard
