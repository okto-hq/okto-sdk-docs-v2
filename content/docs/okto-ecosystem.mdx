...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <FeatureCard
    ...
    title="Okto Wallet"
    description="Okto's flagship consumer application showcasing the power of chain abstraction with 1-click cross-chain swaps, gasless transactions, and 50X leverage trading."
