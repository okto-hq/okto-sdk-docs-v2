...
description: Authenticate users via WhatsApp using Okto's Unity SDK with sendOTP, resendOTP, and loginUsingWhatsApp methods for secure, token-based session management.
full: false
---
