...
- Created your [dashboard account](/docs/developer-admin-dashboard/dashboard-account)
- Obtained [Okto credits](/docs/developer-admin-dashboard/okto-faucet) from Okto Faucet for testing
- Generated your [API keys](/docs/developer-admin-dashboard/api-key)
- Enabled the specific [chains and tokens](/docs/developer-admin-dashboard/wallet-control) you plan to use in your application
- Optional: Configured [sponsorship](/docs/developer-admin-dashboard/sponsorship) for seamless gas abstracted transactions.
