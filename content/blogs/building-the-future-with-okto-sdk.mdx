...
1. **Get Your App Secret (API Key):**  
   Go to the [Okto Dashboard](https://dashboard.okto.tech/) and grab your **App Secret**. This key is essential for authenticating your API requests and integrating Okto’s features into your app.
...
3. **Choose Your Platform:**  
   ...
   - **[React SDK](https://docsv1.okto.tech/docs/react-sdk/getting-started/new-okto-react-setup):** For web applications built with React.  
   - **[React Native SDK](https://docsv1.okto.tech/docs/react-native-sdk/getting-started/new-okto-react-native-setup):** For mobile apps using React Native.  
   - **[Flutter SDK](https://docsv1.okto.tech/docs/flutter-sdk/getting-started/new-okto-flutter-setup):** For cross-platform mobile development with Flutter.  
   - **[Unity SDK](https://docsv1.okto.tech/docs/unity-sdk):** For game developers using Unity.  
   
   Alternatively, you can directly invoke our **[APIs](https://docsv1.okto.tech/api-docs)** for more flexibility.
...
1. **Check Out the Getting Started Blog:**  
   For a detailed step-by-step guide, read the [Getting Started with Okto SDK blog](https://docsv1.okto.tech/blogs/getting-started-with-okto). It covers everything from setting up your Okto App Secret to integrating authentication methods and choosing the right SDK for your project.

2. **Explore the Docs:**  
   Dive into the [SDK Overview](https://docsv1.okto.tech/docs/sdk-overview) and [API Reference](https://docsv1.okto.tech/api-docs) to learn more about Okto’s features and how to use them.
