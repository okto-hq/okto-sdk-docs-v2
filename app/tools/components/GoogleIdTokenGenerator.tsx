...
interface GoogleIdTokenGeneratorProps {
...
export default function GoogleIdTokenGenerator({
  ...
  const ClientId =
    "MTA0NjI3MTUyMTE1NS0wbTQ1M3BvaTVndWEwM2tlaGRjbjV1b24xdnZ1NXU5ai5hcHBzLmdvb2dsZXVzZXJjb250ZW50LmNvbQ==";
