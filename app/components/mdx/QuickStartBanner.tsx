...
export default function QuickStartBanner() {
  ...
  const sectionTitleStyles = "text-lg font-semibold text-zinc-700 dark:text-zinc-300 mb-3 text-center";
  
  return (
    <div className="not-prose flex flex-col items-center px-6 py-5 mb-8 bg-gradient-to-r from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 rounded-lg border-2 border-zinc-200 dark:border-zinc-700 hover:border-zinc-300 dark:hover:border-zinc-600 transition-all shadow-sm">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center">
          <h3 className={sectionTitleStyles}>External Wallet Adapters</h3>
