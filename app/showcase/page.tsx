...
import { Link as ULink, Tooltip } from "@heroui/react";
...
function ShowcaseCard({
  ...
  onOpen: (showcase: (typeof showcases)[0]) => void;
}) {
  return (
    <Card
      ...
      <div className="flex flex-col lg:flex-row justify-between mx-4 lg:mx-16 mt-20 gap-8">
        ...
        <div className="lg:max-w-2xl">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Discover innovative applications built by developers worldwide using
            the Okto SDKs.
          </p>
        </div>
        ...
        <div className="flex lg:flex-col flex-wrap lg:items-end gap-4 lg:ml-auto">
          <ULink
            href="https://docs.google.com/document/d/1zDPUZoHrI4hpdOUgINWkILJJQPrOi3VqGbd2dpyIrdM/edit?usp=sharing"
            className="text-inherit"
          >
            <Button
              className="flex gap-2 rounded-full w-60 items-center justify-center"
              variant="outline"
            >
              <HackIdeasIcon />
              Hack Ideas
          ...
          <ULink
            href="https://forms.gle/VN19AYHnvm7V5qe2A"
            className="text-inherit"
          >
      ...
      <div className="mx-4 lg:mx-16 mt-4">
        <div className="p-4 bg-muted/50 border rounded-lg">
          <p className="text-sm font-medium">
            ⚠️ Disclaimer: These are community projects and are not maintained
            by the Okto team.
          </p>
        </div>
      </div>
            ...
            <div className="flex flex-col gap-4">
              {selectedShowcase.videoUrl ? (
                ...
                <div className="relative w-full aspect-video overflow-hidden rounded-xl">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/50">
                    <Link
                      href={selectedShowcase.videoUrl}
                      target="_blank"
              ...
              <div className="flex gap-3">
                ...
                {selectedShowcase.githubUrl !== "#" && (
                  <Link
                    href={selectedShowcase.githubUrl}
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    <Button variant="outline" className="flex gap-2">
              ...
              {selectedShowcase.description && (
                <div>
                  ...
                  <p className="flex gap-1 text-sm text-muted-foreground py-2">
                    {<MedalIcon />} {selectedShowcase.note}
                  </p>
                </div>
              )}

              <div className="flex items-between gap-2 text-sm text-muted-foreground pt-2">
